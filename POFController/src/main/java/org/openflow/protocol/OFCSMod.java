...
public class OFCSMod extends OFMessage implements Cloneable {
	public static final int MINIMUM_LENGTH = OFMessage.MINIMUM_LENGTH + 100; // 48
	public static final int MAXIMAL_LENGTH = OFCSMod.MINIMUM_LENGTH;

	public enum OFCSEntryCmd {
		OFPCSC_ADD, /* New Cache. */
		OFPCSC_MODIFY, /* Modify matching cache. */
		OFPCSC_DELETE, /* Delete matching cache. */
	}
	 ...
	 * @param command
	 */
	public OFCSMod setCommand(byte command) {
	 ...
	 * @param hardTimeout
	 */
	public OFCSMod setHardTimeout(short hardTimeout) {
	 ...
	 * @param idleTimeout
	 */
	public OFCSMod setIdleTimeout(short idleTimeout) {
	 ...
	 * @param priority
	 */
	public OFCSMod setPriority(short priority) {
	...
	public void writeTo(ChannelBuffer data) {
		...
		data.writeBytes(name.toURIString().getBytes());
	...
	public String toString() {
		...
		string += "; FlowEntry:" + "cmd=" + command + ";st=" + strict + ";it="
				+ idleTimeout + ";ht=" + hardTimeout + ";p=" + priority + ";i="
				+ index + ";m=" + name;
	 ...
	 */
	@Override
	public OFCSMod clone() throws CloneNotSupportedException {
		OFCSMod flowMod = (OFCSMod) super.clone();
		int n = name.count();
